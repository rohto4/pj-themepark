...
Exact next action: add the first failing pure-model fixture for the accepted Bloomworks root instrument, confirm RED for missing graph/topology behavior, then implement only enough session model to reach GREEN before component or visual polish.
