...
| U020 Hero-attraction depth            | Adding copy instead of play                         | Primary / Sol Max          | One realm has a multi-stage learn-play-master loop    | In progress | 0 / ~20m audit             |
...
Exact next action: add the failing Bloomworks component fixture for semantic root graph growth, short-route completion, optional moon sockets, chorus discovery, and keyboard/reset parity; confirm RED before replacing the current three-distinct-gear interface.
