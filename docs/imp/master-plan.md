...
| U022 Constellary performance          | Finale remaining a motif checklist                  | Primary / Sol Max          | Finale becomes an authored deterministic performance  | In progress | 0 / —                      |
...
Exact next action: add a failing pure five-beat Constellary timeline fixture for beginning, development, recognition, climax, and release; prove watch-only/active/muted/reduced/low-power result equivalence before replacing the current four-pulse checklist.
